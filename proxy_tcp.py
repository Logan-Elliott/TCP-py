...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        if len(local_buffer):
            ...
            # if no more data on either sides, close the connections
...
# this is a pretty hex dumping function directly taken from the comments here: http://code.activestate.com/recipes/142812-hex-dumper/
...
def main():
    ...
    if len(sys.argv[1:]) !=5:
        print "Usage: ./proxy_tcp.py [localhost] [localport] [remote host] [remoteport] [receive_first]"
        print "Example: ./proxy_tcp.py 127.0.0.1 9000 10.10.10.1 9000 True"
        sys.exit(0)
